...
_nidza.Utility.loadSync("https://cdnjs.cloudflare.com/ajax/libs/gl-matrix/2.8.1/gl-matrix-min.js", () => {
  ...
  myShaderElement.bgColorB.setDelay(1); // You are free to inject any vars direct on shader component
  ...
  myShaderElement.colorG.setDelay(1); // Override
